...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="app-nav">
    <ul class="navbar-nav mr-auto">
        <li class="nav-item"><a class="nav-link" href="<?php echo URLROOT . '/app/initadmin.php?url=admin/categories';?>">Categories</a></li>
        <li class="nav-item"><a class="nav-link" href="<?php echo URLROOT . '/app/initadmin.php?url=admin/item';?>">Items</a></li>
